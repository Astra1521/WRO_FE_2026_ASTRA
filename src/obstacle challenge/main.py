# main.py
# This code is working with clockwise direction only Dt.07/08/2026
...
if __name__ == "__main__":
    ...
    # 1. Initialize Hardware Sequentially
    camera.initialize()
    motor.initialize()
    servo.initialize()
    ...
    try:
        ...
        while True:
            ...
            # Read sensors sequentially per frame (or skip if needed for speed)
